...
class CN2:
    ...
    def evaluate(self, test_dataset):
        ...
        f1 = self._get_f1_score(precision, recall)
    ...
    def _get_f1_score(self, macro_avg_precision, macro_avg_recall):
        return (2*macro_avg_precision*macro_avg_recall)/(macro_avg_precision + macro_avg_recall)
